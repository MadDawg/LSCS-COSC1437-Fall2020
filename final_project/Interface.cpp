...
namespace cosc1437_final{
    ...
    void import_grades(const std::string& filename, std::vector<Grade>& grades){
        ...
        while(ifs){
            ...
            // It also (conveniently) ignores negative values
    ...
    void export_grades(const std::string& filename, const std::vector<Grade>& grades){
    ...
    void collect_grade_data(std::string& name, double& max_score, double& score){
    ...
    void add_assignment(std::vector<Grade>& grades){
        std::string name;
    ...
    double accumulate_score(const std::vector<Grade>& grades){
    ...
    void calculate_earned_course_score(const std::vector<Grade>& grades, const double max_course_score){
    ...
    void list_assignments(const std::vector<Grade>& grades){
        if (grades.empty()){
    ...
    void show_grade_details(std::vector<Grade>& grades, unsigned index){
